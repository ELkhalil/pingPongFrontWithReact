...
export default function Board() {
    ...
    const socketRef = useRef(socketIO.connect("http://localhost:3000/game", { transports: ['websocket'] }));
    ...
    useEffect(() => {
        ...
        let player2 = new Player(canvas.width - 10, (canvas.height - 100) / 2, 100, 0, "white");
